...
```
The function tq_get recieves an identifier and produces the indicated data.
...
```
The function is vectorized so it can recieve more than one identifier
```{r}
